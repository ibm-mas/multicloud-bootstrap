...
if [[ -f "/tmp/iam-user-created" ]]; then
    log "aws/db2/db2-create-iam-user.sh : /tmp/iam-user-created exists; db2-create-iam-user.sh skipped ..."
else
    log "aws/db2/db2-create-iam-user.sh : /tmp/iam-user-created not exists"
    log "aws/db2/db2-create-iam-user.sh: .......... starts"
    # IAM variables
    ...
    log "aws/db2/db2-create-iam-user.sh: .......... AWS_ACCESS_KEY_ID:DEPLOY_REGION $AWS_ACCESS_KEY_ID : $DEPLOY_REGION"
    # on successful completion of db2-create-iam-user.sh, create a file
    ...
    sleep 60
    log "aws/db2/db2-create-iam-user.sh: .......... ends"
