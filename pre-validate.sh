...
if [[ ! -z $ExistingVPCId ]]; then
  if [[ ( ! -z $ExistingPrivateSubnet1Id) && ( ! -z $ExistingPrivateSubnet2Id) && ( ! -z $ExistingPrivateSubnet3Id) && ( ! -z $ExistingPublicSubnet1Id) && (! -z $ExistingPublicSubnet2Id) && ( ! -z $ExistingPublicSubnet3Id) ]]; then
