...
#Install openshift-install 4.10.37
wget https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/4.10.37/openshift-client-linux-4.10.37.tar.gz
tar -xvf openshift-client-linux-4.10.37.tar.gz
mv openshift-install /usr/local/bin/
rm -rf ./openshift-install-linux-4.10.37.tar.gz
...
wget -q "https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.10.37/openshift-client-linux-4.10.37.tar.gz"
tar -xvf openshift-client-linux-4.10.37.tar.gz
chmod u+x oc kubectl
mv oc /usr/local/bin
mv kubectl /usr/local/bin
rm -rf openshift-client-linux-4.10.37.tar.gz
