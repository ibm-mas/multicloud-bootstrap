...
export MAS_CATALOG_VERSION=v8-240528-amd64
if [[ $CLUSTER_TYPE == "aws" ]]; then
...
export DB2_META_STORAGE_CLASS=$CPD_PRIMARY_STORAGE_CLASS #file
export DB2_DATA_STORAGE_CLASS=$CPD_METADATA_STORAGE_CLASS #block
export DB2_BACKUP_STORAGE_CLASS=$CPD_PRIMARY_STORAGE_CLASS #file
export DB2_LOGS_STORAGE_CLASS=$CPD_METADATA_STORAGE_CLASS
export DB2_TEMP_STORAGE_CLASS=$CPD_METADATA_STORAGE_CLASS
export CPD_SERVICE_NAME="db2wh"

export DB2_INSTANCE_NAME=db2u
...
export MAS_DEVOPS_COLLECTION_VERSION=20.2.0
