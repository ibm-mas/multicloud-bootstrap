...
log "export CLUSTER_TYPE=$CLUSTER_TYPE"
log "export OFFERING_TYPE=$OFFERING_TYPE"
log "export DEPLOY_REGION=$DEPLOY_REGION"
log "export ACCOUNT_ID=$ACCOUNT_ID"
log "export CLUSTER_SIZE=$CLUSTER_SIZE"
log "export RANDOM_STR=$RANDOM_STR"
log "export BASE_DOMAIN=$BASE_DOMAIN"
log "export BASE_DOMAIN_RG_NAME=$BASE_DOMAIN_RG_NAME"
log "export SSH_KEY_NAME=$SSH_KEY_NAME"
log "export DEPLOY_WAIT_HANDLE=$DEPLOY_WAIT_HANDLE"
log "export SLS_ENTITLEMENT_KEY=$SLS_ENTITLEMENT_KEY"
log "export OCP_PULL_SECRET=$OCP_PULL_SECRET"
log "export MAS_LICENSE_URL=$MAS_LICENSE_URL"
log "export SLS_URL=$SLS_URL"
log "export SLS_REGISTRATION_KEY=$SLS_REGISTRATION_KEY"
log "export SLS_PUB_CERT_URL=$SLS_PUB_CERT_URL"
log "export UDS_ENDPOINT_URL=$UDS_ENDPOINT_URL"
log "export UDS_API_KEY=$UDS_API_KEY"
log "export UDS_PUB_CERT_URL=$UDS_PUB_CERT_URL"
log "export MAS_JDBC_USER=$MAS_JDBC_USER"
log "export MAS_JDBC_PASSWORD=$MAS_JDBC_PASSWORD"
log "export MAS_JDBC_URL=$MAS_JDBC_URL"
log "export MAS_JDBC_CERT_URL=$MAS_JDBC_CERT_URL"
log "export MAS_DB_IMPORT_DEMO_DATA=$MAS_DB_IMPORT_DEMO_DATA"
log "export EXS_OCP_URL=$EXS_OCP_URL"
log "export EXS_OCP_USER=$EXS_OCP_USER"
log "export EXS_OCP_PWD=$EXS_OCP_PWD"
log "export RG_NAME=$RG_NAME"
log "export EMAIL_NOTIFICATION=$EMAIL_NOTIFICATION"
log "export RECEPIENT=$RECEPIENT"
log "export SMTP_HOST=$SMTP_HOST"
log "export SMTP_PORT=$SMTP_PORT"
log "export SMTP_USERNAME=$SMTP_USERNAME"
log "export SMTP_PASSWORD=$SMTP_PASSWORD"
log "export AZURE_SP_CLIENT_ID=$AZURE_SP_CLIENT_ID"
log "export AZURE_SP_CLIENT_PWD=$AZURE_SP_CLIENT_PWD"
log "export SELLER_SUBSCRIPTION_ID=$SELLER_SUBSCRIPTION_ID"
log "export TENANT_ID=$TENANT_ID"
log "export BOOTNODE_VPC_ID=$BOOTNODE_VPC_ID"
log "export BOOTNODE_SUBNET_ID=$BOOTNODE_SUBNET_ID"
log "export EXISTING_NETWORK=$EXISTING_NETWORK"
log "export EXISTING_NETWORK_RG=$EXISTING_NETWORK_RG"
log "export EXISTING_PRIVATE_SUBNET1_ID=$EXISTING_PRIVATE_SUBNET1_ID"
log "export EXISTING_PRIVATE_SUBNET2_ID=$EXISTING_PRIVATE_SUBNET2_ID"
log "export EXISTING_PRIVATE_SUBNET3_ID=$EXISTING_PRIVATE_SUBNET3_ID"
log "export EXISTING_PUBLIC_SUBNET1_ID=$EXISTING_PUBLIC_SUBNET1_ID"
log "export EXISTING_PUBLIC_SUBNET2_ID=$EXISTING_PUBLIC_SUBNET2_ID"
log "export EXISTING_PUBLIC_SUBNET3_ID=$EXISTING_PUBLIC_SUBNET3_ID"
log "export PRIVATE_CLUSTER=$PRIVATE_CLUSTER"
log "export OPERATIONAL_MODE=$OPERATIONAL_MODE"
log "export ENV_TYPE=$ENV_TYPE"
log "export GIT_REPO_HOME=$GIT_REPO_HOME"
...
if [[ $PRE_VALIDATION == "pass" ]]; then
  ...
  if [[ $CLUSTER_TYPE == "aws" ]]; then
    if [[ $ENV_TYPE == "dev" ]]; then
      ...
      ansible-galaxy collection install ibm-mas_devops-*.tar.gz --force
  ...
  cd $CLUSTER_TYPE
  ./deploy.sh
log "export DB2_LOGS_STORAGE_CLASS=$DB2_LOGS_STORAGE_CLASS"
log "export DB2_TEMP_STORAGE_CLASS=$DB2_TEMP_STORAGE_CLASS"
log "export DB2_INSTANCE_NAME=$DB2_INSTANCE_NAME"
log "export DB2_VERSION=$DB2_VERSION"
log "export ENTITLEMENT_KEY=$ENTITLEMENT_KEY"
log "export MAS_ENTITLEMENT_KEY=$MAS_ENTITLEMENT_KEY"
log "export MAS_WORKSPACE_ID=$MAS_WORKSPACE_ID"
log "export MAS_WORKSPACE_NAME=$MAS_WORKSPACE_NAME"
log "export MAS_CONFIG_SCOPE=$MAS_CONFIG_SCOPE"
log "export MAS_APP_ID=$MAS_APP_ID"
log "export MAS_APPWS_JDBC_BINDING=$MAS_APPWS_JDBC_BINDING"
log "export MAS_JDBC_CERT_LOCAL_FILE=$MAS_JDBC_CERT_LOCAL_FILE"
log "export MAS_CLOUD_AUTOMATION_VERSION=$MAS_CLOUD_AUTOMATION_VERSION"
log "export MAS_DEVOPS_COLLECTION_VERSION=$MAS_DEVOPS_COLLECTION_VERSION"
log "export MAS_APP_CHANNEL=$MAS_APP_CHANNEL"
log "export new_or_existing_vpc_subnet=$new_or_existing_vpc_subnet"
log "export enable_permission_quota_check=$enable_permission_quota_check"
log "export PRIVATE_CLUSTER=$PRIVATE_CLUSTER"
log "export new_or_existing_vpc_subnet=$new_or_existing_vpc_subnet"
log "export enable_permission_quota_check=$enable_permission_quota_check"
log "export INSTALLATION_MODE=$INSTALLATION_MODE"
log "export INSTALLATION_MODE=$INSTALLATION_MODE"
log "export HOME=$HOME"
log "export MASTER_NODE_COUNT=$MASTER_NODE_COUNT"
log "export WORKER_NODE_COUNT=$WORKER_NODE_COUNT"
log "export MASTER_NODE_COUNT=$MASTER_NODE_COUNT"
log "export WORKER_NODE_COUNT=$WORKER_NODE_COUNT"
log "export MASTER_NODE_COUNT=$MASTER_NODE_COUNT"
log "export WORKER_NODE_COUNT=$WORKER_NODE_COUNT"
log "export MASTER_NODE_COUNT=$MASTER_NODE_COUNT"
log "export WORKER_NODE_COUNT=$WORKER_NODE_COUNT"
log "export DEPLOY_CP4D=$DEPLOY_CP4D"
log "export DEPLOY_MANAGE=$DEPLOY_MANAGE"
log "export AZURE_SUBSC_ID=$AZURE_SUBSC_ID"
log "export BASE_DOMAIN_RG_NAME=$BASE_DOMAIN_RG_NAME"
log "export EXISTING_NETWORK_RG=$EXISTING_NETWORK_RG"
log "export OCP_USERNAME=$OCP_USERNAME"
log "export OCP_PASSWORD=$OCP_PASSWORD"
log "export OPENSHIFT_USER_PROVIDE=$OPENSHIFT_USER_PROVIDE"
log "export OCP_SERVER=$OCP_SERVER"
log "export OPENSHIFT_USER_PROVIDE=$OPENSHIFT_USER_PROVIDE"
  retcode=$?
